...
from polesConstructs_zj import *
...
dataDict={
    ...
    '2-1': {
        ...
        'constructPole1': proChoiceConstruct,
        'constructPole2': proLifeConstruct,
        'RealDataLexicons': LexiconsEnsembl,  # Add any real data lexicons if available
        'axisName': "Pro-Choice to Pro-Life Axis",
    },

    '2-2': {
        'name': 'Health Care Reform',
        'constructPole1': prohealthCareReformConstruct,
        'constructPole2': antihealthCareReformConstruct,
        'RealDataLexicons': LexiconsEnsembl,  # Add any real data lexicons if available
        'axisName': "Pro-Health Care Reform to Anti-Health Care Reform Axis",
    },
    '2-3': {
        'name': 'Macroeconomic Performance',
        'constructPole1': goodMacroEconomyConstruct,
        'constructPole2': badMacroEconomyConstruct,
        'RealDataLexicons': LexiconsEnsembl,  # Add any real data lexicons if available
        'axisName': "Good Economic Performance to Poor Economic Performance Axis",
    },

    '2-4': {
        'name' : "Immigration",
        'constructPole1': proImmigrationConstruct,
        'constructPole2': antiImmigrationConstruct,
        'RealDataLexicons': LexiconsEnsembl,  # Add any real data lexicons if available
        'axisName': "Pro-Immigration to Anti-Immigration Axis",
    }
